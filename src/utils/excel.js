...
exports.saveExcelToFile = saveExcelToFile;
const exceljs_1 = __importDefault(require("exceljs"));
const fs = __importStar(require("fs"));
const path = __importStar(require("path"));
async function generateExcel(reimbursementData, paymentData, monthName) {
...
function saveExcelToFile(buffer, monthName) {
